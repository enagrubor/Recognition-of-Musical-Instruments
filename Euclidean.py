...
X = []  # feature matrix
y = []  # labels (names of the instruments)
...
# Create a list of Serbian names according to order in instruments
...
#knn_raw = KNeighborsClassifier(n_neighbors=3) # euclidean
knn_raw = KNeighborsClassifier(n_neighbors=3, metric='euclidean') # euclidean
#knn_raw = KNeighborsClassifier(n_neighbors=3, weights='distance') # euclidean weighted
...
plt.title("KNN - Original MFCC (Euclidean distance)", fontsize=14, fontweight = 'bold')
#plt.title("KNN - Original MFCC (Euclidean distance, weighted)", fontsize=13, fontweight = 'bold')
plt.show()
...
plt.title("KNN - LDA reduction (Euclidean distance)", fontsize=14, fontweight = 'bold')
#plt.title("KNN - LDA reduction (Euclidean distance, weighted)", fontsize=13, fontweight = 'bold')
plt.show()
...
plt.title("KNN - LFDA reduction (Euclidean distance)", fontsize=14, fontweight = 'bold')
#plt.title("KNN - LFDA reduction (Euclidean distance, weighted)", fontsize=13, fontweight = 'bold')
plt.show()
