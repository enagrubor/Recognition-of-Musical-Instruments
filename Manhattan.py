...
#knn_raw = KNeighborsClassifier(n_neighbors=3, metric='manhattan') # menhetn
knn_raw = KNeighborsClassifier(n_neighbors=3, metric='manhattan', weights='distance') # menhetn oteženjena
...
#plt.title("KNN - Originalni MFCC (Menhetn distanca)", fontsize=14, fontweight = 'bold')
plt.title("KNN - Originalni MFCC (Menhetn distanca, oteženjena)", fontsize=14, fontweight = 'bold')
plt.show()
...
#plt.title("KNN - LDA redukcija (Menhetn distanca)", fontsize=14, fontweight = 'bold')
plt.title("KNN - LDA redukcija (Menhetn distanca, oteženjena)", fontsize=14, fontweight = 'bold')
plt.show()
...
#plt.title("KNN - LFDA redukcija (Menhetn distanca)", fontsize=14, fontweight = 'bold')
plt.title("KNN - LFDA redukcija (Menhetn distanca, oteženjena)", fontsize=14, fontweight = 'bold')
plt.show()
