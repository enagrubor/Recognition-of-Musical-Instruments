...
X = []  # feature matrix
y = []  # labels (name of the instrument)
...
#knn_raw = KNeighborsClassifier(n_neighbors=3, metric='manhattan') # manhattan
knn_raw = KNeighborsClassifier(n_neighbors=3, metric='manhattan', weights='distance') # manhattan oteženjena
...
#plt.title("KNN - Original MFCC (Manhattan distance)", fontsize=14, fontweight = 'bold')
plt.title("KNN - Original MFCC (Manhattan distance, weighted)", fontsize=14, fontweight = 'bold')
plt.show()
...
#knn_lda = KNeighborsClassifier(n_neighbors=3, metric='manhattan')
knn_lda = KNeighborsClassifier(n_neighbors=3, metric='manhattan', weights='distance')

knn_lda.fit(X_lda, y)
y_pred_lda = knn_lda.predict(X_test_lda)
acc_lda = accuracy_score(y_test, y_pred_lda)
print("KNN accuracy (LDA):", round(acc_lda, 3))
...
#plt.title("KNN - LDA reduction (Manhattan distance)", fontsize=14, fontweight = 'bold')
plt.title("KNN - LDA reduction (Manhattan distance, weighted)", fontsize=14, fontweight = 'bold')
plt.show()
...
#knn_lfda = KNeighborsClassifier(n_neighbors=3, metric='manhattan')
knn_lfda = KNeighborsClassifier(n_neighbors=3, metric='manhattan', weights='distance')

knn_lfda.fit(X_lfda, y)
y_pred_lfda = knn_lfda.predict(X_test_lfda)
acc_lfda = accuracy_score(y_test, y_pred_lfda)
print("KNN accuracy (LFDA):", round(acc_lfda, 3))
...
#plt.title("KNN - LFDA reduction (Manhattan distance)", fontsize=14, fontweight = 'bold')
plt.title("KNN - LFDA reduction (Manhattan distance, weighted)", fontsize=14, fontweight = 'bold')
plt.show()
